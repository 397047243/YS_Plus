...
public class AppInfo {
    ...
    private LocalDate updateDate;//更新日期
    ...
    private LocalDateTime onSaleDate;//上架时间
    private LocalDateTime offSaleDate;//下架时间
    private Integer flatformId;//所属平台（来源于：data_dictionary，1 手机 2 平板 3 通用）
    private Integer categoryLevel3;//所属三级分类（来源于：AppCategory）
    ...
    private Integer categoryLevel1;//所属一级分类（来源于：AppCategory）
    private Integer categoryLevel2;//所属二级分类（来源于：AppCategory）
