function  loadCategoryLevel(pid,cl,categoryLevel,url){
	$.ajax({
		type:"GET",//请求类型
		url:url,//请求的url
...
$(function(){  
	...
	var cl3 = $("#cl3").val();
	//动态加载一级分类列表
	loadCategoryLevel(null,cl1,"categoryLevel1","getcategoryLevelList_all");
	//动态加载二级分类列表
	loadCategoryLevel(cl1,cl2,"categoryLevel2","getcategoryLevel1List");
	//动态加载三级分类列表
	loadCategoryLevel(cl2,cl3,"categoryLevel3","getcategoryLevel1List");
	
	//联动效果：动态加载二级分类列表
	$("#categoryLevel1").change(function(){
		var categoryLevel1 = $("#categoryLevel1").val();
		if(categoryLevel1 != '' && categoryLevel1 != null){
			loadCategoryLevel(categoryLevel1,cl2,"categoryLevel2","getcategoryLevel1List");
		}else{
			$("#categoryLevel2").html("");
			var options = "<option value=\"\">--请选择--</option>";
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			loadCategoryLevel(categoryLevel2,cl3,"categoryLevel3","getcategoryLevel1List");
		}else{
			$("#categoryLevel3").html("");
			var options = "<option value=\"\">--请选择--</option>";
			$("#categoryLevel3").html(options);
