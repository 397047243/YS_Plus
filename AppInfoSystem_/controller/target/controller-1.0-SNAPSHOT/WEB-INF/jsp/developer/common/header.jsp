			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/maintain">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a >
							<span class="glyphicon glyphicon-cog1" aria-hidden="true"></span>
						</a> <a >
							<span class="glyphicon glyphicon-ful1lscreen" aria-hidden="true"></span>
						</a> <a > <span
							class="glyphicon glyphicon-eye-1close" aria-hidden="true"></span>
