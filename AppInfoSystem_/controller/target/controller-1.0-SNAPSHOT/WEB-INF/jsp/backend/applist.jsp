...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 审核列表 <i class="fa fa-user"></i><small>${bacUserSession.userName}
						- 您可以通过搜索或者其他的筛选项对APP的信息进行审核操作。^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/bac/list">
			    <ul>
					<li>
					...
					<li>
						...
						<button type="button" class="btn btn-default" id="rset"> 重 &nbsp;&nbsp;&nbsp;&nbsp;置 </button>
					</li>
				</ul>
			</form>
		</div>
    ...
    $(function(){
        ...
        $(".prev").click(function(){ //上一页
            if($(this).attr("val") == "true"){
                ...
                location.href = "list?pageIndex="+(--index);
            }else{
                alert("没有上一页哦！");
            }
        });
